      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative -mt-16 flex flex-col items-center sm:-mt-16 sm:flex-row sm:items-end sm:space-x-5">
          <div className="relative h-32 w-32 overflow-hidden rounded-full border-4 border-green-400 bg-white sm:h-40 sm:w-40">
            ...
            {/* Edit Avatar Button */}
            <div className="bg-opacity-0 hover:bg-opacity-50 absolute inset-0 flex items-center justify-center transition-all">
              <Button
                variant="ghost"
                size="icon"
          ...
          <div className="col-span-2 rounded-lg bg-white p-6 shadow-sm">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                <User className="mt-0.5 mr-3 h-5 w-5 text-gray-500" />
                <div>
              ...
              <div className="flex items-start">
                <Mail className="mt-0.5 mr-3 h-5 w-5 text-gray-500" />
                <div>
                  <h3 className="text-sm font-medium text-gray-500">
                    Email Address
                  </h3>
              ...
              <div className="flex items-start">
                <Shield className="mt-0.5 mr-3 h-5 w-5 text-gray-500" />
                <div>
                  <h3 className="text-sm font-medium text-gray-500">
                    Account Type
                  </h3>
