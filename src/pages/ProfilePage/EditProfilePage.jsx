...
import SectionTitle from '../../components/sub_components/SectionTitle.jsx';
import AvatarUpload from '../../components/sub_components/AvatarUpload.jsx';
import SocialLinkInput from '../../components/sub_components/SocialLinkInput.jsx';
import TextareaField from '../../components/sub_components/TextareaField.jsx';
import { validateForm, scrollToFirstError, validationPatterns } from '../../components/sub_components/validationUtils.jsx';
  ...
  return (
    <div className="bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        {showSuccess && (
          <div className="fixed top-4 right-4 bg-green-100 border-l-4 border-green-500 text-green-700 p-4 rounded shadow-md z-50 animate-fade-in">
            <div className="flex items-center">
              <div className="py-1">
                <svg className="h-6 w-6 mr-4 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="bg-white rounded-lg shadow-sm mt-8 p-6 sm:p-8">
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col sm:flex-row sm:justify-end gap-3">
              ...
              <Button
                ...
                className="bg-gray-800 text-white hover:bg-black transition-colors duration-200"
                type="submit"
              >
                Save Changes
              </Button>
