    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        <div className="flex items-center">
          <BellRing className="text-muted-foreground mr-2 h-4 w-4" />
        ...
        >
          ...
          <SelectContent>
            <SelectItem value={NOTIFY_WHEN.ONE_HOUR_BEFORE}>
              1 hour before
            </SelectItem>
            <SelectItem value={NOTIFY_WHEN.TWELVE_HOURS_BEFORE}>
              12 hours before
            </SelectItem>
            <SelectItem value={NOTIFY_WHEN.ONE_DAY_BEFORE}>
              1 day before
            </SelectItem>
            <SelectItem value={NOTIFY_WHEN.THREE_DAY_BEFORE}>
              3 days before
            </SelectItem>
            <SelectItem value={NOTIFY_WHEN.ONE_WEEK_BEFORE}>
              1 week before
            </SelectItem>
      ...
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground text-xs">
          Note: Public events will be visible to everyone.
        </p>
      </div>
    </div>
  );
