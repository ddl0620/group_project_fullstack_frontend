    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <div className="w-1/2">
              <Label htmlFor="endHour" className="text-xs text-muted-foreground mb-1 block">
                Hour
              </Label>
            ...
            <div className="w-1/2">
              <Label htmlFor="endMinute" className="text-xs text-muted-foreground mb-1 block">
                Minute
              </Label>
      ...
      <div className="text-sm text-muted-foreground">
        Selected time: {formatTime(startHour, startMinute)} - {formatTime(endHour, endMinute)}
      </div>
    </div>
  )
}
