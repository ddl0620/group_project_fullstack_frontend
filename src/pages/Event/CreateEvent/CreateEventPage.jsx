...
export default function CreateEventPage() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (existingImageUrls.length > 0) {
        postData.append(
          'existingImages',
          JSON.stringify(existingImageUrls.map((image) => image.url))
        );
      }
  ...
  const renderFormStage = () => {
    switch (currentStage) {
      ...
      case 2:
        return (
          <EventDateForm formData={formData} handleChange={handleChange} />
        );
      case 3:
        return (
          <EventLocationForm formData={formData} handleChange={handleChange} />
        );
      case 4:
        return (
          <EventImagesForm
          ...
          <Card className="bg-blue-50">
            <CardContent className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="mb-6 text-gray-600">
                Only the event organizer can make changes to this event
              </p>
              <Button
