    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-blue-500 text-white py-16">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <p className="text-xl text-gray-300 max-w-3xl">Meet the team behind Eventify - 5Knights</p>
        </div>
      </div>
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-6 text-[#1f2937]">Our Project</h2>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl font-bold mb-12 text-center text-[#1f2937]">Meet The <span className={"text-blue-500"}>5Knights</span></h2>
            ...
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-[#3b82f6] font-medium text-center mb-4">{member.role}</p>
...
const teamMembers = [
  {
    ...
    sid: "4029308",
    role: "UI/UX Designer",
    avatar: "/member/bach.jpg",
  },
  {
    name: "Dao Duc Lam",
    sid: "4019052",
    role: "Backend Developer",
    avatar: "/member/lam.jpg"
  },
  {
    name: "Tran Dinh Hai",
    sid: "4041605",
    role: "Database Administrator",
    avatar: "/member/hai.jpg",
  },
  {
    name: "Duong Bao Ngoc",
    sid: "3425449",
    role: "QA & Testing Engineer",
    avatar: "/member/ngoc.jpg",
  },
]
