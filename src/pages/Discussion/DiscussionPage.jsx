...
const DiscussionPage = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      <EventSidebar events={mockEvents} selectedEventId={selectedEvent?.id} onEventSelect={handleEventSelect} />
      <div className="flex-1 flex flex-col overflow-hidden">
        {selectedEvent ? (
          ...
          <div className="flex-1 flex items-center justify-center">
            <p className="text-gray-500 text-lg">Select an event to view discussions</p>
          </div>
        )}
      </div>
    </div>
