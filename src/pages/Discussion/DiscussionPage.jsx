...
const DiscussionPage = () => {
  ...
  return (
    <div className="rouned-full m-2 flex h-screen overflow-hidden bg-gray-100">
        ...
        {selectedEvent ? (
          ...
          <div className="flex flex-1 flex-col items-center justify-center gap-4 p-8">
            ...
            <p className="max-w-md text-center text-gray-500">
              Select an event from the sidebar to view discussions or join more
              events to participate in conversations.
            </p>
            {events.length === 0 && (
              <button
                onClick={() => navigate('/browse-events')}
                className="bg-primary hover:bg-primary/90 mt-4 rounded-md px-6 py-2 font-medium text-white transition-colors"
              >
                Browse Events
              </button>
            )}
