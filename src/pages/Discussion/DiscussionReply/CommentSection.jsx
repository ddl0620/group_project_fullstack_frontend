...
import { useImageUploader, ImageUploader } from "@/components/ImageUploader.jsx"
...
export function CommentSection({ postId, initialReplies = [] }) {
  ...
  return (
    <div className="w-full space-y-2 sm:space-y-4 px-2 sm:px-3">
      ...
      <div className="space-y-2 sm:space-y-4">
        {treeStructure.length > 0 ? (
          ...
          <p className="text-muted-foreground py-2 sm:py-4 text-center text-xs sm:text-sm">
