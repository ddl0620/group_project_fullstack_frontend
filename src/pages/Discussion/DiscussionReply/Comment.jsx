...
import {HeartIcon, ImageIcon, MoreHorizontal, Reply, Send} from 'lucide-react';
        ...
        <div className="mt-4">
            <div className="flex gap-3">
                <Avatar className="h-8 w-8 flex-shrink-0">
                    ...
                    <AvatarFallback>
                        {comment.creator_id._id.substring(0, 2).toUpperCase()}
                    </AvatarFallback>
                </Avatar>
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                <span className="font-medium">
                                    User{' '}
                                    {comment.creator_id._id.substring(0, 4)}
                                </span>
