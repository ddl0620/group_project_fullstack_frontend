...
export function NotificationItem({
  ...
  const exactDate = notification.createdAt
  ...
  return (
    <div
      className={cn(
        'group flex cursor-pointer items-start gap-2 border-b p-3 transition-colors hover:bg-gray-50 sm:gap-4 sm:p-4',
      ...
      onClick={handleClick}
    >
      <div className={cn('rounded-full border p-1.5 sm:p-2', getTypeColor())}>
        {getTypeIcon()}
      </div>
