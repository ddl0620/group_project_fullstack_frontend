    ...
    <nav className="fixed z-50 w-full border-b border-neutral-800 bg-neutral-950 font-semibold shadow-sm">
      <div className="mx-auto flex max-w-screen-xl items-center justify-between px-6 py-4">
        <div className="flex items-center gap-10">
          <Link to="/" className="text-xl font-semibold tracking-tight text-white transition-colors hover:text-white">
            EventApp
          </Link>
        ...
        <div className="flex items-center gap-4">
          ...
          <button onClick={() => setMenuOpen(!menuOpen)} className="p-1 text-white md:hidden">
