...
export function AppSidebar({
  ...
  return (
    <>
      ...
      {isMobile && (
        <div
          className="fixed right-0 bottom-0 left-0 z-50 flex h-16 items-center justify-between border-t border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900"
          style={{
            boxShadow:
            ...
            return (
              <Link
                ...
                className={`relative flex h-full flex-1 flex-col items-center justify-center ${
                  isActive
                    ? 'after:absolute after:top-0 after:right-1/4 after:left-1/4 after:h-1 after:rounded-full after:bg-[#0071e3]'
                    : ''
                }`}
                aria-label={item.title}
              >
                <div
                  className={`flex flex-col items-center justify-center rounded-full p-2 transition-all duration-300 ${
                    isActive
                      ? 'bg-blue-50 shadow-[0_0_10px_rgba(59,130,246,0.5)] dark:bg-blue-900/20'
                ...
                <span
                  className={`mt-0.5 ${getTextSize()} text-center font-medium transition-all duration-300 ${
                    isActive
                      ? 'text-[#0071e3] dark:text-blue-400'
                      : 'text-gray-500 dark:text-gray-400'
                  }`}
