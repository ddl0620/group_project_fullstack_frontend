...
export const getEngagementStatsAPI = async (params = {}) => {
    const response = await APIServices.get('/api/v1/userstatis/statis/engagement-stats', {
        params,
    });
...
export const getRsvpTrendAPI = async (params) => {
    const response = await APIServices.get('/api/v1/userstatis/statis/rsvp-trend', {
        params,
    });
    return response.data;
};
...
export const getRsvpDistributionAPI = async (params = {}) => {
    const response = await APIServices.get('/api/v1/userstatis/statis/rsvp-distribution', {
        params,
    });
    return response.data;
};
